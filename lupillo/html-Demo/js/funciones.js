...
$(".btnBuscar").click(function() {  
	if($('#selCriterios option:selected').val() == 1) {
		...
		v.peticion("http://localhost/Servicio/ConSaldoService.svc/rest/GetNombre", objNombre,v.getNombre,"POST");
	};
	if($('#selCriterios option:selected').val() == 2) {
		var objTarjeta = {
			value : {
		...
		v.peticion("http://localhost/Servicio/ConSaldoService.svc/rest/GetTarjeta", objTarjeta,v.getNombre,"POST");
	};
	if($('#selCriterios option:selected').val() == 3) {
		var objCuenta = {
			value : {
		...
		v.peticion("http://localhost/Servicio/ConSaldoService.svc/rest/GetCuenta", objCuenta,v.getNombre,"POST");
	};
	if($('#selCriterios option:selected').val() == 4) {
		var obj = {
		value : {
		...
		v.peticion("http://localhost/Servicio/ConSaldoService.svc/rest/GetCu", obj,v.getCu,"POST");
	};	
});  
